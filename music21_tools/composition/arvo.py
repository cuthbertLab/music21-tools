...
Note: this module is unrelated (except by name and concept) to the later, separate
Python package `arvo` (https://pypi.org/project/arvo/), which is also built on
music21. The two share no code or maintainership.
'''
import copy
