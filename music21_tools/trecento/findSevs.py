# ------------------------------------------------------------------------------
# Name:         music21_tools/trecento/findSevs.py
# Purpose:      methods for finding all sevenths (which might be coding errors) in cadences
#
# Authors:      Michael Scott Asato Cuthbert
#
# Copyright:    Copyright © 2007-2026 Michael Scott Asato Cuthbert
...
def findInWork(work, searchInterval=7):
    ...
    for astream in streams:
        intervals = astream.flatten().melodicIntervals(skipRests=True)
        # genints = []
