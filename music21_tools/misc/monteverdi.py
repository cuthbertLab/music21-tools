# ------------------------------------------------------------------------------
# Name:         music21_tools/misc/monteverdi.py
...
def spliceAnalysis(book=3, madrigal=1):
    ...
    for myN in aMeasures.flatten().notesAndRests:
...
def findPhraseBoundaries(book=4, madrigal=12):
    ...
    analysisFlat  = analysis.flatten().stripTies().getElementsByClass(roman.RomanNumeral)
    ...
    flattenedBass = sc.parts[-1].flatten().notesAndRests
