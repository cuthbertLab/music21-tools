# ------------------------------------------------------------------------------
# Name:         music21_tools/misc/gatherAccidentals.py
...
score and extract a list of notes using music21.stream.Stream.flatten()
...
class Test(unittest.TestCase):
    ...
    def testGetAccidentalCountAdvanced(self):
        ...
        totalNotes = len(s.flatten().notes)
    ...
    def testGetAccidentalCountSumAdvanced(self):
        ...
        totalNotes = len(s1.flatten().notes) + len(s2.flatten().notes)
