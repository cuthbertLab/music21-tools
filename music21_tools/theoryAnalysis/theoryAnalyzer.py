# ------------------------------------------------------------------------------
# Name:         music21_tools/theoryAnalysis/theoryAnalyzer.py
...
class Analyzer:
    ...
    def getVLQs(self, score, partNum1, partNum2):
        ...
        >>> ads = Analyzer()
        >>> ads.getVLQs(sc, 0, 1)
        [<music21.voiceLeading.VoiceLeadingQuartet v1n1=C4, v1n2=G4, v2n1=D4, v2n2=E4>,
         <music21.voiceLeading.VoiceLeadingQuartet v1n1=G4, v1n2=C5, v2n1=E4, v2n2=F5>]
    ...
    def getThreeNoteLinearSegments(self, score, partNum):
        ...
        [<music21.voiceLeading.ThreeNoteLinearSegment
            n1=<music21.note.Note C> n2=<music21.note.Note G> n3=<music21.note.Note C>>,
         <music21.voiceLeading.ThreeNoteLinearSegment
            n1=<music21.note.Note G> n2=<music21.note.Note C> n3=<music21.note.Note C>>]
    ...
    def getLinearSegments(self, score, partNum, lengthLinearSegment, classFilterList=None):
        ...
        [<music21.voiceLeading.TwoChordLinearSegment
            chordList=[<music21.chord.Chord C E G>, <music21.chord.Chord G B D>]>,
         <music21.voiceLeading.TwoChordLinearSegment
            chordList=[<music21.chord.Chord G B D>, <music21.chord.Chord E G C>]>,
         <music21.voiceLeading.TwoChordLinearSegment
            chordList=[<music21.chord.Chord E G C>, <music21.chord.Chord F A C>]>]
        ...
        [<music21.voiceLeading.TwoChordLinearSegment
            chordList=[<music21.harmony.ChordSymbol D->, <music21.harmony.ChordSymbol C11>]>,
         <music21.voiceLeading.TwoChordLinearSegment
            chordList=[<music21.harmony.ChordSymbol C11>, <music21.harmony.ChordSymbol C7>]>]
        '''
    ...
    def getParallelFifths(self, score, partNum1=None, partNum2=None):
        ...
        [<music21.voiceLeading.VoiceLeadingQuartet v1n1=D5, v1n2=E5, v2n1=G4, v2n2=A4>,
         <music21.voiceLeading.VoiceLeadingQuartet v1n1=E5, v1n2=G5, v2n1=A4, v2n2=C4>]
        >>> len(ads.store[sc.id]['ResultDict']['parallelFifths'])
        2
        '''
        sid = score.id
    ...
    def getParallelOctaves(self, score, partNum1=None, partNum2=None):
        ...
        [<music21.voiceLeading.VoiceLeadingQuartet v1n1=C5, v1n2=G5, v2n1=C4, v2n2=G4>]
        '''
        sid = score.id
        testFunction = lambda vlq: vlq.parallelOctave()
    ...
    def identifyMotionType(self, score, partNum1=None, partNum2=None,
        ...
        'Parallel Motion in measure 1: Part 1 moves from F# to E while part 2 moves from C to B'
        '''
